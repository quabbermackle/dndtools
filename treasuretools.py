...
trinket = {'Standard':['A mummified goblin hand',
           ...
           'Mournland':['The favorite childhood toy of one of the adventurers, floating in midair',
                        ...
                        "A cloak pin made of iron in the shape of two hammers joined by a semicircular shaft",
           ...
           'Bookshelves':['A set of "books" that is actually a disguised drawer',
            ...
            'Avernus': ['A 5-inch-long duck carved out of wood. A message on the underside reads, "For Mildred, my plucky duckling." If the word "Mildred" is spoken within 100 feet of the duck, it quacks.',
                        'A slender steel cylinder with a sheet of parchment inside that reads, "Like a lobster in a pot, you think you\'re safe, but you are not / Because the water you are in, is all your greed and all your sin."',
                        'A human skull that constantly mutters and complains.',
                        'A thin bone whistle. If blown in the Nine Hells, it has a 50 percent chance of summoning a bone devil.',
                        'A vulpine doll\'s head that whispers ways you\'re going to die.',
                        'A 2-foot-long feather. A character who succeeds at a successful DC 20 Arcana check can identify it as having come from an erinyes.',
                        'A silver locket containing an image of a beautiful person. Whoever looks at the image must succeed at a DC 15 Wisdom save or become obsessed with finding this person. The spell can be broken by remove curse.',
                        'A withered human hand. The hand has a symbol of Dol Dorn tattooed on it.',
                        'An ashtray made from an imp skull.',
                        'An 8-inch-long iron fang.',
                        'A waterskin that appears to be full of cool water is actually full of dust. Succeeding on a DC 20 Wisdom (Insight) check allows you to see through the illusion. A dispel magic spell breaks the illusion.',
                        'A music box that plays a diabolical melody. Imps find the music irresistible - any imp who hears it must succeed on a DC 15 Wisdom check or cavort uncontrollably to the rousing tune.',
                        'A brochure about vacations in Malbolge. The brochure has a ready-to-sign deal: "For the price of your soul, you get an eternal view of the Torture Labyrinths. Rules and restrictions may apply.',
                        'An eyeball carved out of wood an inlaid with metal and glass.',
                        'A 1-foot-diameter iron bowl ornamented with infernal designs reminiscent of a five-headed dragon.',
                        'An iron ring with the symbol of Zariel on it. It magically fits anyone who puts it on.',
                        'An iron bell 8 inches tall and 5 inches in diameter, etched with infernal symbols.',
                        'A child\'s rattle that looks like Asmodeus. When shaken, it emits countless tiny screams.',
                        'A tattered, leather-bound book written in Infernal, titled "How to Get Ahead."'],
           'Feywild': [ 'Cookie cutter shaped like a unicorn',
                        ...
                        'Tiny wooden stool (sized for a pixie or a sprite) that gives splinters to those who hold it',
                        ...
                        'Notebook that shows what\'s written in it only when held upside down',
                        'Wooden top with four sides, each bearing the image of a child enjoying a different season',
                        'Tiny beehive wig made for sprites or pixies',
                        'Wooden mouse figuring that squeaks when held',
                        ...
                        'Tiny, unfinished dollhouse sized for a pixie child',
            ...
            'Planar':  ["A locket with a picture of your mentor and an inscription you can't read",
                        "A bleached rat skull with colored glass beads in its eye sockets",
                        "A torn parchment with half a rebus puzzle painted on it",
                        "A bracelet of twisted razorvine stems",
                        "A fragment of verdigris-coated bronze blade",
                        "A smooth river stone covered in tiny, carved holy symbols"],
            'Gate':    ["A tiny vial pendant, filled with a drip of honey that glows faintly",
                        ...
                        "A smoldering pebble of coal that, while always hot, doesn't burn skin",
                        "A white feather that sheds dim light in a 5-foot radius",
                        "A ring made from a chain link that, once worn, won't come off without pulling painfully hard"],
            'Knight':  ["A flat silver disk you record your heroics upon",
            ...
            'Mage':    ["An unopened letter from your first teacher",
                        ...
                        "A lens through which you can see the thirteenth moon, Crya, as if it had never been destroyed"],
            'Star Map':["A scroll of living wood that aligns with heavenly bodies",
                        "A stone tablet with fine holes drilled through it marking the positions of stars",
                        "A speckled owlbear hide, tooled with raised marks showing overlapping lunar cycles",
                        "A collection of celestial maps bound in an ebony cover",
            ...
            'Space Junk':  ["A handheld device containing a glowing green gem that darkens when no oxygen is present",
                            ...
                            "A casket containing one hundred tasteless white pills that produce no discernible effect when swallowed",
...
books = ['Tome titled "The Tale of Zord, Mightiest of the Yak Folk"',
         ...
         "An animated map of a mysterious city that appears to be tracking the movements of five creatures",
         "A wall chart of mysterious formulae arranged into a color-coded grid",
         "War and Death: A History of Karrnathi Necromancy, by Jolan Hass Holan",
         "Planar Codex, by Dorius Alyre ir'Korran",
        ]
...
if __name__=='__main__':
    #hoard_treasure('CR 0-4')
    #print(trinket.keys())
    print(simplecoin('2500 cp, 1300 sp, 90 gp'))